...
class SecurityConfig(
    ...
    override fun configure(http: HttpSecurity) {
        ...
        http
            ...
            .addFilterBefore(
                authenticateTokenFilter(authenticationManagerBean(), memberAuthentication),
        ...
        http
            ...
            .and()
            .authorizeRequests()
            .antMatchers("/", "/swagger-ui.html", "/health_check.html", "/oauth2/authorization/**", "/oauth2/refresh")
            .permitAll()
